        ...
        <div>
          ...
          <MagneticEffect>
            <NavMenuLink
              ...
              active={active}
              duration={1.2}
              handleScroll={() => handleScroll("#certifications")}
            />
          </MagneticEffect>
          <MagneticEffect>
            <NavMenuLink
          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            ...
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/imam-budi-prakoso-715054260/?original_referer="
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.4}
                link="https://www.instagram.com/imambds/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.6}
                link="https://www.tiktok.com/@jdprass"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
